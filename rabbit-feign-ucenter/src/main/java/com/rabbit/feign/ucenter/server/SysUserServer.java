...
import com.rabbit.feign.ucenter.FeignUcenterConst;
 ...
 **/
@FeignClient(name = FeignUcenterConst.APPLICATION,fallback = SysUserServerFallbackImpl.class)
public interface SysUserServer{

    @GetMapping(value = FeignUcenterConst.CONTEXTPATH + "/user/getSysUserVoByLogin")
